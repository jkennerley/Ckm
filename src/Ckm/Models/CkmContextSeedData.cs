...
{
    public class CkmContextSeedData
    {
        private CkmContext _context;
        
        private readonly UserManager<CkmUser> userManager;

        public CkmContextSeedData(CkmContext context, UserManager<CkmUser> userManager)
        {
            _context = context;
        ...
        public async Task EnsureSeedDataAsync()
        {
            ...
            if (await this.userManager.FindByEmailAsync("john.kennerley@hotmail.com") == null)
            {
                var user = new CkmUser()
                {
                    UserName = "jkennerley",
                    Email = "john.kennerley@hotmail.com",
                };
